...
import { getDailySchedule, getTodayDate } from "~/lib/data-loader";
...
export default function ModelToday() {
      ...
      <div className="container mx-auto px-4 py-4 sm:py-6">
        {schedule.matches.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-muted-foreground text-lg">No matches scheduled for today</p>
            <p className="text-muted-foreground mt-2">Check back later or view tomorrow's schedule</p>
          </div>
        ) : (
